---
name: oneselect-design
description: Design system skill for oneselect. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# oneselect Design System

You are building UI for **oneselect**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
![oneselect Homepage](screenshots/homepage.png)
...
- Creating new components, pages, or visual elements for oneselect
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "oneselect" design, style, UI, or theme
